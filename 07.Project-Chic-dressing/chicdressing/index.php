...
<div id="chic-products" class="boxed-wrapper clear-fix">
  <h2 class="chic-title">NOS PIÈCES DE CRÉATEUR À PRIX CASSÉS </h2>
  <?php
...
<div id="chic-fashionweek-map" class="boxed-wrapper clear-fix" style="margin-top:30px">
  <h2 class="chic-title">ACHAT-VENTE DE MARQUES DE LUXE </h2>
...
<div
  class="main-content clear-fix<?php echo esc_attr(ashe_options( 'general_content_width' )) === 'boxed' ? ' boxed-wrapper': ''; ?>"
