  ...
  <div id="featured-slider"
    ...
    <div class="slider-item">
      ...
      <div class="slider-item-bg"
        style="background-image:url( <?php echo wp_get_attachment_image_src( $repeater_item->image_url, 'small' )[0]; ?>);">
      </div>
            ...
            <div class="slider-info">
              ...
              <div class="slider-read-more">
                <a href="<?php echo esc_url( $repeater_item->link ); ?>"
                  target="<?php echo $target; ?>"><?php echo $repeater_item->btn_text; ?></a>
              </div>
              <?php endif; ?>
