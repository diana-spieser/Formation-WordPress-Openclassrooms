...
<div class="main-container">
  ...
  <?php
	...
	echo '<h2 id="leblog" class="chic-title"> News Mode & Luxe pour vous!</h2>';
  ...
  <div class="no-result-found">
    ...
    <p>
      <?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'ashe' ); ?>
    </p>
